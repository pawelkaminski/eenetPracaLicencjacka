...
Fifaka i~Gryzogrzechotalskiego %\cite{ffgg}.
...
Rozdzia³~%\ref{r:fifak}
przedstawia teoriê Fifaka i~wyja¶nia sposób jej
...
Do uruchomienia aplikacji w trybie dewelopersim (przy ustawionym \verb+DEBUG = True+ w ustawieniach projektu) wystarczy sam kod zapewniany przez Django, mianowicie plik
